...
export default {
  ...
  admin: {
    ...
    coverage: {
      title: "Coverage map",
      description:
        "Where CasaClean has completed turnovers. Hover a marker for the city's photo and stats.",
      statCities: "Cities covered",
      statCompleted: "Completed turnovers",
      statRevenue: "Completed revenue",
      listTitle: "Cities with completed turnovers",
      empty:
        "No completed turnovers yet. Once a booking is marked completed, its city appears here.",
      services: "Services",
