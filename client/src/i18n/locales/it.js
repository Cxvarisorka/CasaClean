...
export default {
  ...
  admin: {
    ...
    nav: {
      ...
      services: "Servizi",
      cities: "Città",
      coverage: "Mappa copertura",
      users: "Utenti",
    },
    coverage: {
      title: "Mappa copertura",
      description:
        "Dove CasaClean ha completato i riassetti. Passa il mouse su un segnaposto per la foto e le statistiche della città.",
      statCities: "Città coperte",
      statCompleted: "Riassetti completati",
      statRevenue: "Ricavi completati",
      listTitle: "Città con riassetti completati",
      empty:
        "Ancora nessun riassetto completato. Quando una prenotazione è segnata come completata, la sua città appare qui.",
      services: "Servizi",
      completedShort: "completati",
      revenueShort: "ricavi",
