...
export default {
  ...
  booking: {
    ...
    schedule: {
      ...
      noticeHint: "Questo servizio richiede {hours} ore di preavviso: la prima data disponibile è il {date}.",
      instantHint: "Questo servizio è prenotabile anche per oggi, purché la squadra finisca prima della chiusura.",
      ...
      timeIssue: {
        ...
        tooSoon: "Le prenotazioni richiedono almeno {hours} ore di preavviso. Il primo orario disponibile è il {earliestDate} alle {earliestTime}.",
        durationExceeds: "La durata scelta supera l'orario di lavoro della città. {city} chiude alle {close}, quindi da quell'ora restano {remainingDuration}. Inizia entro le {latest} oppure scegli una durata più breve.",
    ...
    preferences: {
      ...
      durationTotal: "Totale: {duration}",
      durationHint: "Inserisci ore e minuti — una visita può durare da 1 a 6 ore.",
